...
import com.serdar.marketrnotomasyonu.databinding.ActivityUrunlerBinding;
...
public class urunler extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            ArrayAdapter adaptor = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, yazilacakIfadeler);
    ...
    public void urunDetay(View view) {
        Intent urunekle = new Intent(urunler.this, urunDetay.class);
